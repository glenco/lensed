...
params
{
    ...
    { "q3", PARAMETER, POS_BOUND, -0.0f }, { "a3", ANGLE, UNBOUNDED, -0.0f },
    { "q4", PARAMETER, POS_BOUND, -0.0f }, { "a4", ANGLE, UNBOUNDED, -0.0f },
    { "q5", PARAMETER, POS_BOUND, -0.0f }, { "a5", ANGLE, UNBOUNDED, -0.0f },
    { "q6", PARAMETER, POS_BOUND, -0.0f }, { "a6", ANGLE, UNBOUNDED, -0.0f },
    { "q7", PARAMETER, POS_BOUND, -0.0f }, { "a7", ANGLE, UNBOUNDED, -0.0f },
    { "q8", PARAMETER, POS_BOUND, -0.0f }, { "a8", ANGLE, UNBOUNDED, -0.0f },
    { "q9", PARAMETER, POS_BOUND, -0.0f }, { "a9", ANGLE, UNBOUNDED, -0.0f },
    { "p2", PARAMETER, POS_BOUND, -0.0f }, { "b2", ANGLE, UNBOUNDED, -0.0f },
    { "p3", PARAMETER, POS_BOUND, -0.0f }, { "b3", ANGLE, UNBOUNDED, -0.0f },
    { "p4", PARAMETER, POS_BOUND, -0.0f }, { "b4", ANGLE, UNBOUNDED, -0.0f },
    { "p5", PARAMETER, POS_BOUND, -0.0f }, { "b5", ANGLE, UNBOUNDED, -0.0f },
    { "p6", PARAMETER, POS_BOUND, -0.0f }, { "b6", ANGLE, UNBOUNDED, -0.0f },
    { "p7", PARAMETER, POS_BOUND, -0.0f }, { "b7", ANGLE, UNBOUNDED, -0.0f },
    { "p8", PARAMETER, POS_BOUND, -0.0f }, { "b8", ANGLE, UNBOUNDED, -0.0f },
    { "p9", PARAMETER, POS_BOUND, -0.0f }, { "b9", ANGLE, UNBOUNDED, -0.0f }
};
